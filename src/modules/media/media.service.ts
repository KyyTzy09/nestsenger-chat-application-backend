...
import { GetMediaByRoomIdDto } from "./media.dto";
...
export class MediaService {
    ...
    async getMediaByRoomId(dto: GetMediaByRoomIdDto): Promise<ResponseType<ChatMedia[]>> {
        ...
        return { message: "Media Retrieved Successfully", statusCode: HttpStatus.OK, data: existingMedia }
    }
}